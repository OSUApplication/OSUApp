...
//   check(){
//     console.log("checking radio = ",this.myRadio);
//                 console.log("checking end time = ",this.endTimeStruct);
//                if(this.startTimeStruct.minute < 10){
//                  this.startTimeStruct.minute = 0+this.startTimeStruct.minute;
//                }
//         console.log("checking start time = ",this.startTimeStruct);
